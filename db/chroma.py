...
_collection: Optional[chromadb.api.models.Collection] = None


def _get_collection() -> Optional[chromadb.api.models.Collection]:
    """Lazily connect to Chroma and return the collection."""
    ...
    try:
        ...
        _collection = _client.get_or_create_collection(
            "threads_memory", embedding_function=embedding_func
        )
        return _collection
